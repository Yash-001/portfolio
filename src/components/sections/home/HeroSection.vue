...
.hero__role-prefix { color: var(--text-tertiary); }
...
.hero__btn-primary:hover {
  box-shadow: 0 12px 40px color-mix(in srgb, var(--color-primary) 55%, transparent) !important;
...
.meta-item i { color: var(--text-disabled); font-size: 12px; }
